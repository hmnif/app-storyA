package com.example.storyapp_awal.data.remote.retrofit

import com.example.storyapp_awal.data.remote.response.DetailResponse
import com.example.storyapp_awal.data.remote.response.LoginResponse
import com.example.storyapp_awal.data.remote.response.RegisterResponse
import com.example.storyapp_awal.data.remote.response.StoryResponse
